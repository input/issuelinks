...
The 'Issue links' text filter provides a modified version of
the functionality found on drupal.org project issues whereby users can link from one
project issue to another in a project issue's node or comment body
simply using the shorthand syntax [#1234] (or [#1234-2] for comments).

All you need to reference another issue is its issue number.
...
color coded to reflect the referenced issue's status.

Issue links will also always reflect the current state of the referenced issue.
